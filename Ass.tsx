...
const Ass = () => {
    return (
        <View style={
            ...
            <Image style={{marginLeft:20,width:22,height:22,marginTop:23, marginVertical:10,}} source={require('./image/Menu.png')}/>
            <Image style={{marginLeft:300,width:22,height:22, marginTop:-36}} source={require('./image/search.png')}/>
            <Image style={{marginLeft:360,width:22,height:22, marginTop:-25,}} source={require('./image/magaza.png')}/>
            <Text style={
                styles.textstile
...
<Image style={{marginTop:7,marginLeft:340}} source={require('./image/isaresiz.png')}/>
        </View>
    )
}
